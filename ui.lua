    ...
    do
        ...
        Library.KeybindList = function(Self)
            ...
            function KeybindList:UpdateSize()
                ...
                local TargetHeight = Count > 0 and (Y - 4) or 16
                local TargetWidth = math.max(100, Width)
        
                Items["Content"].Instance.Size = UDim2.new(0, TargetWidth, 0, TargetHeight)
                Items["KeybindList"]:Tween({Size = UDim2.new(0, TargetWidth + 16, 0, TargetHeight + 12)}, KeybindTweenInfo)
        ...
        Library.Page = function(Self, Params)
            ...
            local Items = { } do 
                ...
                if Params.SubPages or Params.subPages then
                    -- Create SubTabHolder
                    ...
                    -- Divider line
                    Items["SubTabDivider"] = Library:Create("Frame", {
                        Name = "Divider",
                        Parent = Items["Page"].Instance,
                        BorderSizePixel = 0,
                        BackgroundColor3 = Library.Theme["Outline"],
            ...
            function Page:SubPage(Params)
                Params = Params or {}
                local SubPage = {
                    Name = Params.Name or "SubPage",
                    Window = Page.Window,
                    ParentPage = Page,
                    ColumnsData = {},
                    SubPages = {},
                ...
                local PageFrame = Page.Items["Page"].Instance
                
                SubPage.Items["SubPageFrame"] = Library:Create("Frame", {
                    Name = SubPage.Name,
                    Parent = PageFrame,
                    BackgroundTransparency = 1,
                ...
                SubPage.Items["LeftColumn"] = Library:Create("ScrollingFrame", {
                    Name = "\0",
                    Parent = SubPage.Items["SubPageFrame"].Instance,
                    ScrollBarThickness = 0,
                    BackgroundTransparency = 1,
                ...
                Library:Create("UIListLayout", {
                    Parent = SubPage.Items["LeftColumn"].Instance,
                    Padding = UDim.new(0, 15),
                    SortOrder = Enum.SortOrder.LayoutOrder
                })
                Library:Create("UIPadding", {
                ...
                SubPage.Items["RightColumn"] = Library:Create("ScrollingFrame", {
                    Name = "\0",
                    Parent = SubPage.Items["SubPageFrame"].Instance,
                    ScrollBarThickness = 0,
                    BackgroundTransparency = 1,
                ...
                Library:Create("UIListLayout", {
                    Parent = SubPage.Items["RightColumn"].Instance,
                    Padding = UDim.new(0, 15),
                    SortOrder = Enum.SortOrder.LayoutOrder
                })
                Library:Create("UIPadding", {
                ...
                SubPage.ColumnsData[1] = SubPage.Items["LeftColumn"]
                SubPage.ColumnsData[2] = SubPage.Items["RightColumn"]
                
                local SubTabButton = Library:Create("TextButton", {
                    Name = SubPage.Name,
                    Parent = Page.Items["SubTabHolder"].Instance,
                    Text = SubPage.Name,
                    FontFace = Library.Font,
                    TextSize = Library.FontSize,
                    TextColor3 = Library.Theme["Inactive Text"],
                ...
                SubPage.Items["Button"] = SubTabButton
                
                SubTabButton:OnHover(function()
                    if SubPage.Active then return end
                    SubTabButton:Tween({TextColor3 = Library.Theme.Text})
                end, function()
                    if SubPage.Active then return end
                    SubTabButton:Tween({TextColor3 = Library.Theme["Inactive Text"]})
                end)
                
                function SubPage:Select()
                    for _, sibling in ipairs(Page.SubPages) do
                        if sibling ~= SubPage and sibling.Active then
                            sibling.Active = false
                            sibling.Items["SubPageFrame"].Instance.Visible = false
                            sibling.Items["Button"]:ChangeItemTheme({TextColor3 = "Inactive Text"})
                            sibling.Items["Button"]:Tween({TextColor3 = Library.Theme["Inactive Text"]})
                        end
                    end
                    
                    SubPage.Active = true
                    SubPage.Items["SubPageFrame"].Instance.Visible = true
                    SubPage.Items["Button"]:ChangeItemTheme({TextColor3 = "Accent"})
                    SubPage.Items["Button"]:Tween({TextColor3 = Library.Theme.Accent})
                end
                
                function SubPage:SetVisibility(Bool)
                    SubTabButton.Instance.Visible = Bool
                    if not Bool and SubPage.Active then
                        SubPage.Active = false
                        SubPage.Items["SubPageFrame"].Instance.Visible = false
                        SubTabButton:ChangeItemTheme({TextColor3 = "Inactive Text"})
                        SubTabButton:Tween({TextColor3 = Library.Theme["Inactive Text"]})
                        for _, sibling in ipairs(Page.SubPages) do
                            if sibling.Items["Button"].Instance.Visible then
                                sibling:Select()
                                break
                            end
                        end
                ...
                SubTabButton:Connect("MouseButton1Down", function()
                    SubPage:Select()
                end)
        ...
        Library.CreateSettingsPage = function(self, Window, Watermark, KeybindList)
            return Window:Page({Name = "UI Settings", Columns = 2})
        end
    end
end
