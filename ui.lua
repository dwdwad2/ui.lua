...
local Library do
        ...
        Components.WindowPage = function(self, Data)
            ...
            function Page:Turn(Bool)
                ...
                if Page.Active then
                    ...
                    Items["Inactive"]:Tween(nil, {BackgroundTransparency = 0.2})
                    ...
                    Items["Text"]:Tween(nil, {Position = UDim2New(0, 10, 0.5, 0)})
                end
    ...
    Library.Window = function(self, Data)
        ...
        local Window = { 
            ...
            FadeTime = Data.FadeTime or Data.fadetime or 0,
        ...
        local Items = Components:Window({
            ...
            Position = UDim2New(0, Camera.ViewportSize.X / 4.3, 0, Camera.ViewportSize.Y / 5.4),
            Size = Window.Size
        }) do
