...
local Library do
    ...
    local Themes = {
        ["Preset"] = {
            ...
            ["Hovered Element"] = FromRGB(37, 24, 47),
            ["Page Background"] = FromRGB(20, 20, 20),
            ["Outline"] = FromRGB(106, 80, 108),
            ["Element"] = FromRGB(18, 18, 18),
            ["Gradient"] = FromRGB(218, 192, 218),
            ["Text"] = FromRGB(235, 230, 240),
            ["Text Stroke"] = FromRGB(10, 10, 10),
            ["Placeholder Text"] = FromRGB(170, 150, 170),
            ["Accent"] = FromRGB(218, 192, 218)
        }
    }
