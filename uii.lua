...
local Library = { 
    ...
    -- SubTab Support
    Library.CreateSubTab = function(Self, Parent, Name)
        local SubTab = {
            Name = Name,
            Items = {},
            Visible = true,
